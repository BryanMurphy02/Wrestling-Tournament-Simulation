...
public class init {
    ...
    */
    ...
    // try{
    //     FileReader wrestlers = new FileReader("\\wrestlers.txt");

	// 	Scanner reader = new Scanner(wrestlers);
	...
	// 		strength = Double.valueOf(temp.substring(0, temp.indexOf("'")));
	// 		temp = temp.substring(temp.indexOf("'") + 1);

	// 		id = Integer.valueOf(temp.substring(0, temp.indexOf("'")));
	// 		temp = temp.substring(temp.indexOf("'") + 1);

	// 		weight = Double.valueOf(temp.substring(0, temp.indexOf("'")));
	// 		temp = temp.substring(temp.indexOf("'") + 1);
